		...
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
				<div class='col-md-4'>
							...
							<a href='view_products.php?pid=$pro_id'><div class='panel-body'>
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right; width:140px; height:40px; margin-right:5px;" name="login_user_with_product" class="btn btn-info" value="Ready to Checkout" >
							</form>';
